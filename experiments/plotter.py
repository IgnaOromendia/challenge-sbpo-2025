...
def plot_standard_vs_not_local_search_obj():
    instancias = [
        ...
        ("standard_04_B.csv", "not_using_local_search_04_B.csv", "Instance 4 B"),
        ("standard_12_B.csv", "not_using_local_search_12_B.csv", "Instance 12 B"),
        ("standard_15_B.csv", "not_using_local_search_15_B.csv", "Instance 15 B")
    ]
    ...
    plt.tight_layout()
    plt.savefig("plots/local_search_cmp.png")
    plt.show()
...
def plot_standard_vs_not_greedy_obj():
    ...
    plt.tight_layout()
    plt.savefig("plots/greedy_cmp.png")
    plt.show()
...
def plot_standard_vs_not_local_search_time():
    ...
    plt.tight_layout()
    plt.savefig("plots/local_search_cmp_time.png")
    plt.show()
...
def plot_standard_vs_not_greedy_time():
    ...
    plt.tight_layout()
    plt.savefig("plots/greedy_cmp_time.png")
    plt.show()
